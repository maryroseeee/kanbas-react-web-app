        ...
        <div id="wd-people-table">
            <table className="table table-striped">
                ...
                <tr><td className="wd-full-name text-nowrap">
                    ...
                    <td className="wd-login-id">001254361C</td>
                    <td className="wd-section">S101</td>
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2024-10-02</td>
                    <td className="wd-total-activity">10:00:22</td> </tr>
                <tr><td className="wd-full-name text-nowrap">
                    <FaUserCircle className="me-2 fs-1 text-secondary" />
                    <span className="wd-first-name">Bruce</span>{" "}
                    <span className="wd-last-name">Wayne</span></td>
                    <td className="wd-login-id">210054361B</td>
                    <td className="wd-section">S101</td>
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2024-09-27</td>
                    <td className="wd-total-activity">09:07:09</td> </tr>
                <tr><td className="wd-full-name text-nowrap">
                    <FaUserCircle className="me-2 fs-1 text-secondary" />
                    <span className="wd-first-name">Natasha</span>{" "}
                    <span className="wd-last-name">Romanoff</span></td>
                    <td className="wd-login-id">38095736BW</td>
                    <td className="wd-section">S101</td>
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2024-09-29</td>
                    <td className="wd-total-activity">08:11:49</td> </tr>
                </tbody>
            </table>
        </div> );}